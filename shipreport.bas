...
Application.DisplayAlerts = False
    ...
    Planinformation = "YW MARKET PURCHASE"
    ...
    For i = 0 To 70
            ...
            Else
                ...
                Else
                    ...
                    If wks1.Range("E" & j).Value = "Ë®±­" Then
                       wks1.Range("E" & j).Value = "ÀñÆ·ºÐ"
                       wks1.Range("C" & j).Value = "gift box"
                       waterbottle = "water bottle description gift box"
                    ElseIf wks1.Range("E" & j).Value = "Ì«Ñô¾µ" Then
                       wks1.Range("E" & j).Value = "ÀñÆ·"
                       wks1.Range("C" & j).Value = "gift set"
                       sunglass = "sunglass description gift"
                    ElseIf wks1.Range("E" & j).Value = "²ÍºÐ" Then
                       wks1.Range("E" & j).Value = "ÀñÆ·ºÐ"
                       wks1.Range("C" & j).Value = "gift box"
